    ...
    export default {
        ...
        methods: {
            init() {
                ...
                // console.log("初始化验证码",this.codeChose)
                this.$store.commit("setCodeForVertfyCode",this.codeChose)
            ...
            setCode() {
                if (this.isEnd == false) {
                    ...
                    if (this.type === '1') {		//普通验证码 图片选择
                        ...
                        //点击图片或按钮换验证码
                        // console.log("普通验证码",this.codeChose)
                        this.$store.commit("setCodeForVertfyCode",this.codeChose)
                        // console.log("store验证码",this.$store.state.imgCode)
